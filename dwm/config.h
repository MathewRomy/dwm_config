...
static const char gruv1[]       ="#eadbb2"; //cream
static const char gruv2[]       ="#282828"; //black
static const char gruv3[]       ="#689d69"; //green
static const char gruv4[]       ="#cc231c"; //red
static const char gruv5[]       ="#d79922"; //yellow
static const char gruv6[]       ="#458587"; //blue


static const char *colors[][3]      = {
	/*					fg         bg          border   */
	[SchemeNorm] =	 { gruv2, gruv1, gruv1 }, //x01
	[SchemeSel]  =	 { gruv1, gruv2, gruv2 }, //x02
	[Scheme3] =	 { gruv3, gruv2, gruv2 }, //x03
	[Scheme4]=	 { gruv4, gruv2, gruv2 }, //x04
	[Scheme5]=  { gruv6, gruv2, gruv2 }, //x05
	[Scheme6]   =  {gruv6, gruv2 ,gruv2 }, //x06 last leftover block imp****
	[Scheme7]     =  {col_black, col_11  , col_11 }, //x07
