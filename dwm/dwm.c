...
enum { SchemeNorm, SchemeSel, Scheme3, Scheme4, Scheme5, Scheme6, Scheme7, Scheme8, Scheme9, Scheme10, Scheme11, Scheme12  }; /* color schemes */
...
struct Monitor {
	...
	int gappx;            /* gaps between windows *int gappx; */
