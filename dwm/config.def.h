...
static const char *fonts[]          = {"mononoki Nerd Fonts Mono:size=12", "JoyPixels:size=12","monospace:size=10" };
...
static const char *colors[][3]      = {
	...
	[Scheme3] =	 { col_5, col_gray1, col_gray2 }, //x03
	[SchemeUrgent]=	 { col_white, col_red,    col_red }, //x04
	[SchemeCharge]=  { col_green, col_gray1,  col_gray2 }, //x05
	[SchemeFull]   =  { col_white, col_green,  col_green }, //x06
